 ...
 *
 * <p>
 * This class is a thin wrapper around the RDKit native drawing APIs and
 * is responsible for:
 * <ul>
...
public class DepictSmiles {
   ...
   * </p>
   *
   * @param smiles A non-null, non-empty SMILES string representing a valid chemical structure.
   * @throws RuntimeException If the SMILES string cannot be parsed, the molecule cannot be rendered,
   *                          or the output file cannot be written.
   */
  public void create2DPng(String smiles) {
    RWMol mol = RWMol.MolFromSmiles(smiles);

    MolDraw2DCairo drawer = new MolDraw2DCairo(
        600,    // width
        600,    // height
        -1,     // panel width
        -1,     // panel height
    ...
    drawer.drawOptions().setScalingFactor(2.0);
